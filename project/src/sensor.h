...
public:
	Sensor(float fov)
		...
		, m_inverse_pose(1.0f)
	{
		m_intr[0] = glm::mat3(glm::vec3(fov, 0.0f, 0.0f), glm::vec3(0.0f, fov, 0.0f), glm::vec3(319.5f, 239.5f, 1.0f));
		m_intr[1] = glm::mat3(glm::vec3(fov * 0.5f, 0.0f, 0.0f), glm::vec3(0.0f, fov * 0.5f, 0.0f), glm::vec3(159.5f, 119.5f, 1.0f));
		m_intr[2] = glm::mat3(glm::vec3(fov * 0.25f, 0.0f, 0.0f), glm::vec3(0.0f, fov * 0.25f, 0.0f), glm::vec3(79.5f, 59.5f, 1.0f));
