...
#include <glm/glm.hpp>
    ...
    */
    __global__ void constructIcpResidualsKernel(cudaSurfaceObject_t vertex_map, cudaSurfaceObject_t target_vertex_map, 
        glm::mat3x3 &previous_rotation_mat, glm::vec3 &previous_translation_vec, unsigned int width, unsigned int height, 
...
__device__ std::array<unsigned int, 2> computeCorrespondence(glm::vec3 &vertex_global, 
